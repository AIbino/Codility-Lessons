    ...
    for i in num:
        if i == '0':
            ...
            if zeroCount > maxZeroCount: 
                # when a 1 in reached, compare current 0 count to max
                maxZeroCount = zeroCount 
                # if 0 count is higher than max, set max to 0 count
            zeroCount = 0
            # reset 0 count and continue through loop
        else:
            break
